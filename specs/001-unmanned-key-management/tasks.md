...
- [ ] T012 [US1] Create Cloud Function `pickupItem` in `miniprogram/cloudfunctions/pickupItem/index.js`
- [ ] T013 [US1] Implement `pickupItem` logic using `management-core` (assign password, update status, log transaction)
- [ ] T014 [US1] Create Mini Program page `pages/index/index` for scanning and item selection
- [ ] T015 [US1] Implement item selection UI and confirmation flow in `pages/index/index`
- [ ] T016 [US1] Connect frontend to `pickupItem` Cloud Function and display assigned password
...
- [ ] T017 [US2] Create Cloud Function `returnItem` in `miniprogram/cloudfunctions/returnItem/index.js`
- [ ] T018 [US2] Implement `returnItem` logic using `management-core` (assign password, release item, log transaction)
- [ ] T019 [US2] Create "Active Pickups" view in `pages/active/active` showing items held by user
- [ ] T020 [US2] Implement "One-Click Return" button and password display in `pages/active/active`
...
- [ ] T021 [US3] Implement `adminManageItem` Cloud Function for CRUD operations on items
- [ ] T022 [US3] Implement `adminUploadPasswords` Cloud Function for bulk password upload
- [ ] T023 [US3] [P] Implement CLI command `mgmt-cli items add/delete` in `packages/management-cli/src/items.ts`
- [ ] T024 [US3] [P] Implement CLI command `mgmt-cli passwords upload` in `packages/management-cli/src/passwords.ts`
- [ ] T025 [US3] Create Cloud Function `checkPoolAndNotify` triggered by password status changes
- [ ] T026 [US3] Implement WeChat Service Message notification in `checkPoolAndNotify` for count < 30
- [ ] T027 [US3] Create Admin Dashboard page `pages/admin/admin` in Mini Program for inventory overview

## Phase 6: Polish & Cross-Cutting

- [ ] T028 Implement global loading states and error handling for all Cloud Function calls
- [ ] T029 Add logging and performance markers as per Article VI
- [ ] T030 Final verification of all user journeys in WeChat DevTools
